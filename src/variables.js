...
const INITIAL_SETTING_SHEET =
  SpreadsheetApp.getActiveSpreadsheet().getSheetByName(
    INITIAL_SETTING_SHEET_NAME
  );
...
const RESULT_SHARE_FULFAC_BODY =
  INITIAL_SETTING_SHEET.getRange('C4').getValue();
const RESULT_SHARE_ADJFAC_BODY =
  INITIAL_SETTING_SHEET.getRange('C5').getValue();
...
const RESULT_SHARE_FULFAC_SHEETNAME =
  INITIAL_SETTING_SHEET.getRange('C7').getValue();
const RESULT_SHARE_ADJFAC_SHEETNAME =
  INITIAL_SETTING_SHEET.getRange('C8').getValue();
